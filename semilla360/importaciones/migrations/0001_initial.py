# Generated by Django 5.0.9 on 2025-01-15 20:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_recojo', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='importaciones.empresa')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='despacho',
            name='ordenes_compra',
            field=models.ManyToManyField(to='importaciones.ordencompra'),
        ),
        migrations.AddField(
            model_name='despacho',
            name='producto',
        ...
        migrations.AddField(
            model_name='despacho',
            name='proveedor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='importaciones.proveedor_transporte'),
        ),
        migrations.AddField(
            model_name='despacho',
            name='transportista',
